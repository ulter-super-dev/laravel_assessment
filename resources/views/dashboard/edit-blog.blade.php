    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="/update-api" method="POST" class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-4">
                    ...
                    <div class="mb-4 flex justify-end">
                        <input type="submit" value="Update" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-l">
                        <input type="submit" value="Remove" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-r">
                    </div>
                </form>
            </div>
        </div>
